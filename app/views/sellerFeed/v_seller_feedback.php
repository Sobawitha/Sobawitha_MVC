...
<link rel="stylesheet" href="../css/seller/seller_feedback.css"></link>
        ...
        <div class="section_2">
          <section class="customerFeed">
            ...
            <div class="cus_feedbacks">
                <i class="fa-regular fa-message" id="message"></i><span class="feedback_section_header"> Feedbacks(69)</span><br><br>
