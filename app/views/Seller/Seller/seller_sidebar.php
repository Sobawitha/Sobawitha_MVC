...
<div class="sidebar">
    ...
    <ul>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/seller_ad_management') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/seller_ad_management/View_listing"><i class="fa-solid fa-heart-circle-check"></i>&nbsp;&nbsp;Wish List</a></li>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/seller_order_list') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/seller_purchase/display_all_purchases"><i class="fa-solid fa-basket-shopping"></i>&nbsp;&nbsp;View Purchases</a></li>
