...
<div class="sidebar">
    ...
    <ul>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/seller_buy') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/supplier_ad_view/index"><i class="fa-solid fa-cart-shopping"></i></i>&nbsp;&nbsp;Buy Raw-materials</a></li> 
