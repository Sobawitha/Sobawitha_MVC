...
<div class="sidebar">
    ...
    <ul>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/seller_order_list') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/seller_order_list/view_orders"><i class="fa-solid fa-basket-shopping"></i>&nbsp;&nbsp;View Purchases</a></li>
