...
<div class="sidebar">
    ...
    <ul>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/seller_order_list') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/fertilizer_product/view_orders"><i class="fa-sharp fa-solid fa-store"></i>&nbsp;&nbsp;Orders</a></li> 
