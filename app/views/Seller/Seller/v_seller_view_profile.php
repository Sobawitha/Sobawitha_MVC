...
<div class="body">
    ...
    <div class="section_2">  
        ...
        <div class="three_btns">
                <h4>Settings</h4>
                <div class="button" >
                <a href="<?php echo URLROOT?>/Seller/updateProfile"><input type="button" id="update_btn" value="Update Profile"></a>
                </div>
                ...
                <dialog id="deactivateUserPopup">
                    <div class="deactivateUserPopup">
                      ...
                      <div class="dialog__content">
                        <a href="<?php echo URLROOT?>/Seller/deactivateAccount/<?php echo $_SESSION['user_id'] ?>" id="yes">Yes</a>
                        <a href="<?php echo URLROOT?>/Seller/profile " id="no">No</a>
                      </div>
                    </div>
                    </dialog>
                </div>
        ...
        <div class="container">
            ...
            <div class="profile_image">
                ...
                <form method="POST" action="<?php echo URLROOT?>/Seller/change_profile_pic " enctype="multipart/form-data">
                ...
                <dialog id="confirmingChangePicPopup">
                    ...
                    <div class="dialog__content">
                        ...
                        <button type="button" id="no_btn" onclick="location.href='<?php echo URLROOT?>/Seller/profile'">No</button>
