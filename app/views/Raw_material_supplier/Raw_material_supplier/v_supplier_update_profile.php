...
<div class="body">
    ...
    <div class="section_2">  
        ...
        <div class="container">
            ...
            <form method="POST" action="<?php echo URLROOT?>/Supplier/updateProfile" enctype="multipart/form-data">
                ...
                <dialog id="updateUserPopup">
                    <div class="updateUserPopup">
                      ...
                      <div class="dialog__content">
                        ...
                        <button type="button" id="no" onclick="location.href='<?php echo URLROOT?>/Supplier/profile'">No</button>
                      </div>
                    </div>
                    </dialog>
            ...
            <div class="profile_image">
                ...
                <button type="button" id="change_img" >Change picture </button>
                    ...
                    <div class="deactivateUserPopup">
                      ...
                      <div class="dialog__content">
                        <a href="<?php echo URLROOT?>/Supplier/delete_profile_pic?>" id="yes">Yes</a>
                        <a href="<?php echo URLROOT?>/Supplier/updateProfile " id="no">No</a>
                      </div>
                    </div>
                    </dialog>
                </div>
