...
<div class="sidebar">
    ...
    <ul>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/supplier_ad_management') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/supplier_ad_management/index" class=""><i class="fa-solid fa-gear"></i>&nbsp;&nbsp;Manage ads</a></li>
