...
<div class="sidebar">
    ...
    <ul>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/supplier_dashboard') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/supplier_dashboard/supplier_dashboard" class=""><i class="fas fa-table"></i>&nbsp;&nbsp;Dashboard</a></li>
        <li class="<?php if (strpos($current_url, URLROOT.'/supplier_ad_management') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/supplier_ad_management/indexfilter" class=""><i class="fa-solid fa-gear"></i>&nbsp;&nbsp;Manage ads</a></li>
        ...
        <li class="<?php if (strpos($current_url, URLROOT.'/supplier_rm_product') !== false) echo 'active'; ?>"><a href="<?php echo URLROOT?>/supplier_rm_product/view_orders" class=""><i class="fa-solid fa-list-check"></i>&nbsp;&nbsp;View orderlist</a></li>
