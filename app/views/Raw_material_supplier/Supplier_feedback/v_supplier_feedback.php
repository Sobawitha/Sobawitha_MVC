        ...
        <div class="section_2">
          <section class="customerFeed">
            ...
            <div class="scf_maincontent">
              ...
              <span class="cf_heading">Supplier Rating</span>
              ...
              <form method ="POST" action="<?php echo URLROOT?>/supplier_feedback/view_all_feed" id="filter_form">
              <div class="row">
                <div class="side">
                <div class="n_star">
                <label class="radio-btn"><input type="radio"  id="all" name="feed_type"  onclick="javascript:submit()" value = "all"<?php if (isset($_POST['feed_type']) && $_POST['feed_type'] == 'all') echo ' checked="checked"';?> checked>All
                ...
                <div class="side">
                <div class="n_star">
                <label class="radio-btn"><input type="radio" id="fives" name="feed_type" value="fives" onclick="javascript:submit()"  value = "fives"<?php if (isset($_POST['feed_type']) && $_POST['feed_type'] == 'fives') echo ' checked="checked"';?>>5 star
                <span class="checkmark"></span>
              </label>
              </div>
              </div>
              ...
              <div class="side">
                ...
                <label class="radio-btn"> 
                  <input type="radio" id="fours" name="feed_type" value="fours" onclick="javascript:submit()"  value = "fours"<?php if (isset($_POST['feed_type']) && $_POST['feed_type'] == 'fours') echo ' checked="checked"';?>>4 star
                  <span class="checkmark"></span>
              </label>
                </div>
              </div>
              ...
              <div class="side">
                <div class="n_star">
                <label class="radio-btn"> 
                  <input type="radio" id="threes" name="feed_type" value="threes" onclick="javascript:submit()"  value = "threes"<?php if (isset($_POST['feed_type']) && $_POST['feed_type'] == 'threes') echo ' checked="checked"';?>>3 star
                  <span class="checkmark"></span>
                </label>
                </div>
              </div>
              ...
              <div class="side">
                <div class="n_star">
                <label class="radio-btn"> 
                  <input type="radio" id="twos" name="feed_type" value="twos" onclick="javascript:submit()"  value = "twos"<?php if (isset($_POST['feed_type']) && $_POST['feed_type'] == 'twos') echo ' checked="checked"';?>>2 star
                  <span class="checkmark"></span>
                </label>
                </div>
              </div>
              ...
              <div class="side">
                <div class="n_star">
                <label class="radio-btn"> 
                  <input type="radio" id="ones" name="feed_type" value="ones" onclick="javascript:submit()"  value = "ones"<?php if (isset($_POST['feed_type']) && $_POST['feed_type'] == 'ones') echo ' checked="checked"';?>>1 star
                  <span class="checkmark"></span>
              </label>
                </div>
              </div>
