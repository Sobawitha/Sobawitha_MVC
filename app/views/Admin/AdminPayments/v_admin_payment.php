...
<div class="body">
        ...
        <div class="search_bar">
            <div class="search_content">
                    ...
                    <span class="search_cont" onclick="open_cancel_btn()"><input type="text" name="search" id="searchBar" placeholder="<?php echo $data['search'] ?>" require/></span>
         ...
         <a href ="<?php echo URLROOT ?> /Admin_payments/generate_report" id="genReport" ><button class="gen_report"><i class="fa-solid fa-file-invoice"></i> Generate Report</button></a>
          ...
          <?php if($data['search'] ==='Search by payer firstname or lastname'): ?>
                ...
                <form method ="POST" action="<?php echo URLROOT?>/Admin_payments/view_payments" id="filter_form">
                        <label for="all" id="filter_label"> <input type="radio" id="all" name="payment_type" onclick="javascript:submit()" value="all" <?php if (isset($_POST['payment_type']) && $_POST['payment_type'] == 'all') echo ' checked="checked"';?> checked>Online</label>
                ...
                <?php if(empty($data['emptydata'])){ ?>
                        ...
                        <?php }else{ ?>
                            <div class="error-msg-container">  
                                <span class="error-msg-db"><?php echo $data['message']; ?></span>
                        </div>
                    <?php    }  ?>  
...
function clear_search_bar(){
  ...
  window.location.replace("<?php echo URLROOT?>/Admin_payments/view_payments");
