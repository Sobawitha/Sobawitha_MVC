        ...
        <div class="wrapper">
            <div class="btn_main_container">
                    <div class="popup_heading">
                      <div class="popup_heading_choose">
                    <label id="user_add_heading"> Choose the User for Registrations...</label><hr>
                    </div> 
                    <div class="closebtn"> 
                    <a href=""><label for="" ><i class="fa fa-times-circle" aria-hidden="true"></i></label></a><br>  
                   </div> 
                   </div> 
                  
                    
                    <div class="user_choose_btns">
                      <div class="foot">
                      <a href="<?php echo URLROOT?>/Admin_user_management/add_new_admin"> <button type="button" class="publish" name="submit" ><i class="fa-solid fa-user-gear"></i> Add Admin</button></a>
                      </div>
                      <div class="foot">
                      <a href="<?php echo URLROOT?>/Admin_user_management/add_new_agri"> <button type="button" class="publish" name="submit"><i class="fa-solid fa-user-tie"></i> Add Agri-Officer</button></a>
                      </div>
                    </div>
