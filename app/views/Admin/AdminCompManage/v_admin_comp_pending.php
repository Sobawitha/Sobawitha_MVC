                                        ...
                                        <div class="filter_section">
                                                <div class="radio-buttons" id="radioButtons">
                                                        <form method="POST" action="<?php echo URLROOT ?>/Admin_complaints_management/view_complaints" id="filter_form">
                                                                <label for="pending_comp" id="filter_label"> <input type="radio" id="pending_comp" name="comp_type" onclick="javascript:submit()" value="pending_comp"   <?php
                                                                if (isset($_POST['comp_type']) && $_POST['comp_type'] == 'pending_comp') {
                                                                echo 'checked="checked"';
                                                                $_SESSION['radio_admin_comp'] = 'pending_comp';
                                                                } elseif (!isset($_POST['comp_type'])) {
                                                                echo 'checked';
                                                                $_SESSION['radio_admin_comp'] = 'pending_comp';
                                                                } ?> checked>Pending</label>
                                                                
                                                                <label for="solved" id="filter_label">
                                                                <input type="radio" id="solved" name="comp_type" onclick="javascript:submit()" value="solved"
                                                                <?php 
                                                                if (isset($_POST['comp_type']) && $_POST['comp_type'] == 'solved') {
                                                                echo ' checked="checked"';
                                                                $_SESSION['radio_admin_comp'] = 'solved';
                                                                } elseif (!isset($_POST['comp_type']) && isset($_GET['comp_type']) && $_GET['comp_type'] == 'solved') {
                                                                echo ' checked="checked"';
                                                                $_SESSION['radio_admin_comp'] = 'solved';
                                                                }
                                                                ?>
...
<script>
      ...
      window.location.replace("<?php echo URLROOT?>/Admin_complaints_management/view_complaints");
