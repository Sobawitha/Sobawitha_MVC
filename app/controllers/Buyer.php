<?php
    class Buyer extends Controller {
     ...
     if(isset($_SESSION['user_id']) && $_SESSION['user_flag']==2) {
       ...
       $deleteStatus= $this->buyerModel->deactivateUser($user_id);
 ...
 public function updateProfile(){
    ...
    if(empty($data['first_name_err']) && empty($data['last_name_err']) && empty($data['address_line_one_err']) && empty($data['address_line_two_err']) && empty($data['address_line_three_err'])  && empty($data['nic_err'])&& empty($data['contact_number_err']) && empty($data['birthday_err']) && empty($data['address_line_four_err'])){
        ...
        if($this->buyerModel->updateBuyer($data)){
            ...
            $this->view('Buyer/Buyer/v_buyer_update_profile',$data);
    ...
    public function change_profile_pic(){
        if(isset($_SESSION['user_id']) && $_SESSION['user_flag']==2) {
          ...
          $changeStatus= $this->buyerModel->updateProPic($data);
      ...
      public function delete_profile_pic(){
        if(isset($_SESSION['user_id']) && $_SESSION['user_flag']==2) {
          ...
          $deleteStatus= $this->buyerModel->deleteProPic($user_id,$user_gender);
